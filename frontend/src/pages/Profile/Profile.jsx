        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="flex items-center gap-6">
            <div className="relative">
              ...
              <button className="absolute bottom-0 right-0 w-10 h-10 rounded-full bg-black text-white border-2 border-white flex items-center justify-center hover:scale-105 transition-transform">
                <FaCamera />
              </button>
            </div>
            <div>
          ...
          <div className="w-full lg:w-[350px]">
            <div className="flex justify-between mb-3">
              ...
              <span className="font-black text-[#8B5CF6]">{completion}%</span>
            </div>
            <div className="w-full h-3 bg-zinc-200 rounded-full overflow-hidden">
              <div 
        ...
        <div className="bg-white rounded-[28px] border border-zinc-200 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <input
              ...
              className="w-full border border-zinc-300 bg-white text-black rounded-xl p-3 outline-none focus:ring-2 focus:ring-[#8B5CF6] focus:border-[#8B5CF6]"
            />
            <input
              placeholder="Email"
              value={profile.email}
            ...
            <div className="grid grid-cols-2 gap-3">
              <input
                ...
                className="border border-zinc-300 bg-white text-black rounded-xl p-3 outline-none focus:ring-2 focus:ring-[#8B5CF6] focus:border-[#8B5CF6]"
              />
              <select
                value={profile.gender}
